...
def loop():
    options = OrderedDict()
    options['A'] = Option('Add a bookmark', commands.AddBookmarkCommand(), prep_call=get_new_bookmark_data,
                          success_message='Bookmark added!')
    options['B'] = Option('List bookmarks by date', commands.ListBookmarksCommand())
    options['T'] = Option('List bookmarks by title', commands.ListBookmarksCommand(order_by='title'))
    options['E'] = Option('Edit a bookmark', commands.EditBookmarkCommand(), prep_call=get_new_bookmark_info,
                          success_message='Bookmark updated!')
    options['D'] = Option('Delete a bookmark', commands.DeleteBookmarkCommand(), prep_call=get_bookmark_id_for_deletion,
                          success_message='Bookmark deleted!')
    options['G'] = Option('Import GitHub stars', commands.ImportGitHubStarsCommand(), prep_call=get_github_import_options,
                          success_message='Improted {result} bookmarks from starred repos!')
